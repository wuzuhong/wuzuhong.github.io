...
1. 容器启动时，找到配置文件中的context-param作为键值对放到ServletContext中：
    ...
    <listener> 
        <listener-class>com.wuzuhong.contextlistener.listener.ContextListenerTest</listener-class>
    </listener>
    ```
...
1. applicationContext.mxl中：
    ```xml
    <context:component-scan base-package="com.wuzuhong.test">
...
2. spring-mvc.xml中：
    ```xml
    <context:component-scan base-package="com.wuzuhong.test" use-default-filters="false"> 
