# 【微服务—springcloud】微服务架构
## 概述
* 微服务架构是一种架构模式，或者说是一种架构风格，它提倡将原始的单一应用拆分成一组小的服务（通常是按业务来拆分），每个服务运行在其独立的进程中，彻底的去耦合，专业的服务做专业的事情。
...
* 微服务只是后端业务逻辑代码，不会和HTML、CSS或其他前端组件混合（前端通过REST API与后端服务进行数据交互）
