...
* 系统环境变量
* JVM启动参数
* application-{profile}.properties或者application-{profile}.yaml配置文件
...
* 通过新增一个自定义类，继承 PropertySourcesPlaceholderConfigurer 类，并重写 postProcessBeanFactory 方法，重写的这个方法先和源码一致，然后在源码的基础上再添加自己的实现代码即可。

apollo 配置中心也往 SpringBoot 中添加了配置源。
