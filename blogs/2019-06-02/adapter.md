...
#### 小结
Adapter 类继承了 Source220V 类，也实现了 Target5V 接口，于是 Adapter 类同时拥有 Source220V 和 Target5V 的功能，并且在实现 Target5V 接口的时候用到了 Source220V 类中的方法，所以类适配器其实是一种隐式适配。**其实类适配器有点不好理解，而且也没必要理解，用的不多**。
